...
class Proj1Data:
    ...
    # def export_collection_as_dataframe(self, collection_name: str, database_name: Optional[str] = None) -> pd.DataFrame:
    #     try:
    #     # Add these debug prints before accessing the collection
    #         if database_name is None:
    #             print("Using database:", self.mongo_client.database.name)  # Add this to print database name
    #             print("Using collection name:", collection_name)          # Add this to print collection name
    #             collection = self.mongo_client.database[collection_name]
    #         else:
    #             print("Using database:", database_name)                    # If database_name passed explicitly
    #             print("Using collection name:", collection_name)
    #             collection = self.mongo_client[database_name][collection_name]
